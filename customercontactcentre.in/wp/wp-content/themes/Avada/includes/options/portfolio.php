...
function avada_options_section_portfolio( $sections ) {
	...
	$sections['portfolio'] = [
		...
		'fields'   => [
					...
					'portfolio_archive_load_more_posts_button_bg_color' => [
						...
						'css_vars'    => [
							[
								...
								'element'  => '.fusion-portfolio-archive',
								'callback' => [ 'sanitize_color' ],
							],
							[
								'name'     => '--portfolio_archive_load_more_posts_button_bg_color-8a',
								'element'  => '.fusion-portfolio-archive',
								'callback' => [ 'color_alpha_set', '0.8' ],
							],
							[
								'name'     => '--portfolio_archive_load_more_posts_button_bg_color-readable-color',
								'element'  => '.fusion-portfolio-archive',
								'callback' => [
									'get_readable_color',
									[
			...
			'portfolio_single_post_page_options_subsection' => [
				...
				'fields'      => [
					...
					'portfolio_disable_first_featured_image' => [
						...
						'partial_refresh' => [
							'portfolio_disable_first_featured_image_partial' => [
