	...
	public function admin_menu() {
		...
		if ( current_user_can( 'switch_themes' ) ) {
			...
			if ( ! defined( 'ENVATO_HOSTED_SITE' ) ) {
				...
				$support      = $avada_submenu_page_creation_method( 'avada', esc_attr__( 'Support', 'Avada' ), esc_attr__( 'Support', 'Avada' ), 'manage_options', 'avada-support', [ $this, 'support_tab' ] );
			}

			$faqs          = $avada_submenu_page_creation_method( 'avada', esc_attr__( 'FAQ', 'Avada' ), esc_attr__( 'FAQ', 'Avada' ), 'switch_themes', 'avada-faq', [ $this, 'faq_tab' ] );
			...
			add_action( 'admin_print_scripts-' . $faqs, [ $this, 'faq_screen_scripts' ] );
