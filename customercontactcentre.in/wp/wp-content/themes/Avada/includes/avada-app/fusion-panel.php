						...
						<# if ( 'undefined' !== typeof param.label && 'custom' !== param.type ) { #>
							...
							<ul class="fusion-panel-options">
								...
								<# if ( 'undefined' !== param.to_default && '' !== param.to_default && param.to_default ) { #>
									<li><a href="JavaScript:void(0);"><span class="fusion-panel-shortcut" data-fusion-option="{{ param.to_default.id }}"><i class="fusiona-cog"></i></a><span class="fusion-elements-option-tooltip fusion-tooltip-global-settings"><?php echo esc_attr__( 'Theme Options', 'fusion-builder' ); ?></span></li>
								<# } #>
