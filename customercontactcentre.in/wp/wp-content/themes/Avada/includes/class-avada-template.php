...
class Avada_Template {
	...
	private function body_classes( $classes ) {
		...
		if ( class_exists( 'Tribe__Events__Main' ) ) {
			if ( function_exists( 'tribe_get_option' ) && '100-width.php' !== tribe_get_option( 'tribeEventsTemplate', 'default' ) || ( is_singular( 'tribe_events' ) && 'sidebar' === Avada()->settings->get( 'ec_meta_layout' ) ) ) {
