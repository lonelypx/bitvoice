			...
			<div class="fusion-important-notice fusion-auto-patcher">
				...
				<?php if ( ! empty( $messages ) ) : ?>
					<?php foreach ( $messages as $message_id => $message ) : ?>
						...
						?>
						<p class="fusion-patcher-error"><?php echo $message; // phpcs:ignore WordPress.Security ?></p>
					<?php endforeach; ?>
				<?php endif; ?>
									...
									<td class="patch-description">
										<?php if ( isset( $messages[ 'write-permissions-' . $patch_id ] ) ) : ?>
											<div class="fusion-patcher-error" style="font-size:.85rem;">
												<?php echo $messages[ 'write-permissions-' . $patch_id ]; // phpcs:ignore WordPress.Security ?>
											</div>
										<?php endif; ?>
										<?php echo $patch_args['description'][0]; // phpcs:ignore WordPress.Security ?>
									</td>
