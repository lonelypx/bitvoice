...
<script type="text/template" id="fusion-builder-row-template">
		...
		<span class="fusion-builder-empty-container">
			<div class="fusion-builder-module-controls-container">
				<div class="fusion-builder-controls fusion-builder-module-controls">
					<a href="#" class="fusion-builder-insert-column"><span class="fusiona-add-columns"></span><span class="fusion-column-tooltip"><span class="fusion-tooltip-text"><?php esc_html_e( 'Add Columns', 'fusion-builder' ); ?></span></span></a></span>
				</div>
			</div>
	...
	<a href="#" class="fusion-builder-insert-column"><span class="open"><span class="fusiona-plus"></span> <?php esc_html_e( 'Add Columns', 'fusion-builder' ); ?></a>
</script>
