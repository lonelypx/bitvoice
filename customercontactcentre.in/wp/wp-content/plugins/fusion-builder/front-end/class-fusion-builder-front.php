...
if ( ! class_exists( 'Fusion_Builder_Front' ) ) {
	...
	class Fusion_Builder_Front {
		...
		public function live_scripts( $hook ) {
			...
			wp_enqueue_script( 'draggable-overrides', FUSION_BUILDER_PLUGIN_URL . 'front-end/draggable-overrides.js', [ 'jquery-ui-draggable', 'jquery-ui-droppable' ], FUSION_BUILDER_VERSION, true );
