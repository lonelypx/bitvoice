			...
			columnSpacing: function( event ) {
				...
				$columnSpacer.resizable( {
					...
					resize: function( event, ui ) {
						...
						$el.css( 'margin-right', modelSpacing );
						...
						// Right padding overlap.
						if ( 20 > ui.size.width && 20 > $el.find( '> .fusion-column-padding-right' ).width() ) {
							jQuery( ui.element ).parent().addClass( 'fusion-overlap' );
							$el.find( '> .fusion-column-padding-right' ).addClass( 'fusion-overlap' );
						} else {
							jQuery( ui.element ).parent().removeClass( 'fusion-overlap' );
							$el.find( '> .fusion-column-padding-right' ).removeClass( 'fusion-overlap' );
						}
					},
