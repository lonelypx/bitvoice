	...
	jQuery( document ).ready( function() {
		...
		FusionPageBuilder.fusion_social_links = FusionPageBuilder.ElementView.extend( {
			...
			buildIcons: function( values ) {
				var buttonMarginClass = _.fusionGetSocialNetworks( values ),
					icons;

				buttonMarginClass = _.fusionSortSocialNetworks( buttonMarginClass, values );
				icons             = _.fusionBuildSocialLinks( buttonMarginClass, this.socialLinksIconAttr, values );
