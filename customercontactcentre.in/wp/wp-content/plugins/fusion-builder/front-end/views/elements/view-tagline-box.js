	...
	jQuery( document ).ready( function() {
		...
		FusionPageBuilder.fusion_tagline_box = FusionPageBuilder.ElementView.extend( {
			...
			buildButtonAttr: function( values ) {
				var attrButton = {
					class: 'button fusion-button button-' + values.buttoncolor + ' button-' + values.button_shape + ' fusion-button-' + values.button_size + ' button-' + values.button_size + ' button-' + values.button_type
				};
