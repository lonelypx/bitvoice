...
<ul class="fusion-sortable-text-options" id="{{ param.param_name }}">
	...
	<# _.each( values, function( value ) { #>
		<div class="fusion-sortable-option">
			...
			<a href="#" class="fusion-sortable-move" aria-label="<?php esc_attr_e( 'Move Row', 'fusion-builder' ); ?>">
				<span class="fusiona-icon-move"></span>
			</a>
			<a href="#" class="fusion-sortable-remove" aria-label="<?php esc_attr_e( 'Remove Row', 'fusion-builder' ); ?>">
