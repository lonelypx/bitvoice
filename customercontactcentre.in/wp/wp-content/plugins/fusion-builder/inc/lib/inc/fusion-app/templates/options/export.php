...
<div class="fusion-form-radio-button-set ui-buttonset fusion-export-mode">
	...
	<a href="#" class="ui-button buttonset-item" data-value="download" aria-label="<?php esc_attr_e( 'File Download', 'fusion-builder' ); ?>"><?php esc_attr_e( 'File Download', 'fusion-builder' ); ?></a>
</div>
