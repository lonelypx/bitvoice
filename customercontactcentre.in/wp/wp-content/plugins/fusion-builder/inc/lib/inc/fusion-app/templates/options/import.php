...
<div class="fusion-form-radio-button-set ui-buttonset fusion-import-mode">
	...
	<a href="#" class="ui-button buttonset-item" data-value="upload" aria-label="<?php esc_attr_e( 'File Upload', 'fusion-builder' ); ?>"><?php esc_attr_e( 'File Upload', 'fusion-builder' ); ?></a>
	<# if ( hasDemos ) { #>
