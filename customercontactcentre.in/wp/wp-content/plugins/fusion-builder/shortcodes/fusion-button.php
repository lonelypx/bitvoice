	...
	if ( ! class_exists( 'FusionSC_Button' ) ) {
		...
		class FusionSC_Button extends Fusion_Element {
			...
			public function render( $args, $content = '' ) {
				...
				$using_default_shape = false;
				if ( ( isset( $args['shape'] ) && ( '' === $args['shape'] || 'default' === $args['shape'] ) ) || ! isset( $args['shape'] ) ) {
					$using_default_shape = true;
				}
				...
				$defaults['default_shape']   = $using_default_shape;
			...
			public function attr() {
				...
				$shape = 'fusion-button-' . $this->args['shape'];
				if ( $this->args['default_shape'] ) {
					$shape = 'fusion-button-default-shape';
				}
				...
				$attr['class'] = 'fusion-button button-' . $this->args['type'] . ' ' . $shape . ' ' . $size . ' button-' . $this->args['color'] . ' button-' . $this->element_id . ' ' . $stretch . ' ' . $type;
			...
			public function add_options() {
				...
				Fusion_Dynamic_CSS::add_replace_pattern( '.fusion-builder-elements-button-main-shape-round', Fusion_Dynamic_CSS_Helpers::get_elements_string( $dynamic_css_helpers->map_selector( $main_elements, '', '.fusion-button_shape-round' ) ) );
				Fusion_Dynamic_CSS::add_replace_pattern( '.fusion-builder-elements-button-main-shape-square', Fusion_Dynamic_CSS_Helpers::get_elements_string( $dynamic_css_helpers->map_selector( $main_elements, '', '.fusion-button_shape-square' ) ) );
				Fusion_Dynamic_CSS::add_replace_pattern( '.fusion-builder-elements-button-main-shape-pill', Fusion_Dynamic_CSS_Helpers::get_elements_string( $dynamic_css_helpers->map_selector( $main_elements, '', '.fusion-button_shape-pill' ) ) );
						...
						'fields' => [
							...
							'button_shape'                 => [
								...
								'output'      => [
									[
										...
										'function'      => 'attr',
										'attr'          => 'class',
										'value_pattern' => 'fusion-button_shape-$',
										'remove_attrs'  => [ 'fusion-button_shape-square', 'fusion-button_shape-round', 'fusion-button_shape-pill' ],
										'toLowerCase'   => true,
									],
								],
							],
							...
							'button_accent_hover_color'    => [
								...
								'css_vars'    => [
									...
									[
										'name'     => '--button_accent_hover_color-fallback-to-transparent',
										'callback' => [ 'fallback_to_value', 'transparent' ],
									],
								],
								'preview'     => [
									'selector' => '.fusion-button,.fusion-button .wpcf7-submit',
