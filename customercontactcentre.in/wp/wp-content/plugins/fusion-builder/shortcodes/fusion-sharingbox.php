		...
		class FusionSC_SharingBox extends Fusion_Element {
			...
			public static function get_element_defaults() {
				...
				return [
					...
					'icons_boxed'        => ( 1 == $fusion_settings->get( 'sharing_social_links_boxed' ) ) ? 'yes' : $fusion_settings->get( 'sharing_social_links_boxed' ), // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
