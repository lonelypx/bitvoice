				...
				if ( 'liftup' === $hover_type || ( 'bottomshadow' === $style && ( 'none' === $hover_type || 'zoomin' === $hover_type || 'zoomout' === $hover_type ) ) ) {
					...
					if ( 'liftup' === $hover_type ) {
						...
						if ( 'zoomin' === $hover_type || 'zoomout' === $hover_type ) {
							$wrapper_classes = 'fusion-image-frame-bottomshadow element-bottomshadow image-frame-shadow-' . $this->imageframe_counter;
						} else {
							$wrapper_classes = 'fusion-image-frame-bottomshadow image-frame-shadow-' . $this->imageframe_counter;
						}
						$element_styles = '';
						$element_styles = '<style>.fusion-image-frame-bottomshadow.image-frame-shadow-' . $this->imageframe_counter . '{';
						if ( 'left' === $align ) {
