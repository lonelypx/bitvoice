...
class FusionCore_Plugin {
	...
	*/
	...
	private function __construct() {
		...
		add_action( 'after_setup_theme', [ $this, 'load_fusion_core_text_domain' ] );
	...
	public function load_fusion_core_text_domain() {
		load_plugin_textdomain( 'fusion-core', false, dirname( plugin_basename( dirname( __FILE__ ) ) ) . '/languages' );
	}
